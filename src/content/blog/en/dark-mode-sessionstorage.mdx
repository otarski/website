---
title: "Why Otarski Uses sessionStorage for Dark Mode (Not localStorage)"
description: "Dark mode is the default experience in Otarski — and that's a deliberate design decision. Here's the reasoning, the code, and exactly how to change it."
publishedAt: 2026-03-15
author: "Team"
tags: ["dark-mode", "otarski", "design", "tutorial"]
featured: false
locale: en
...
Most dark mode implementations ask: "what did the user last choose?" Otarski asks a different question: "what is the right default for this site?" The answer is dark — always — and `sessionStorage` is the technical expression of that decision.
...
Dark mode is not a fallback for Otarski. It is the primary visual experience. The typography, colour palette, and contrast ratios were all designed and tested in dark mode first. Light mode works and is fully supported, but the site is at its best in the dark.
...
Otarski uses `sessionStorage` because the site has a clear visual identity and dark mode is part of it. If you are building a business site, a documentation portal, or anything serving a broad audience, `localStorage` or OS preference is the more considerate default.

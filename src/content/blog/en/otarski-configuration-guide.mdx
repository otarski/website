---
title: "Otarski Configuration — Every Toggle, Theme, and Layout Option Explained"
description: "A complete walkthrough of Otarski's configuration options: 12 colour themes, OKLCH colours, typography, radius and shadow tokens, header styles, dark mode, and more."
publishedAt: 2026-04-18
author: "Team"
tags: ["otarski", "configuration", "customization", "themes"]
featured: false
locale: en
image: "../../../assets/blog/otarski-configuration-guide.svg"
svgSlug: "otarski-configuration-guide"
imageAlt: "Feature overview graphic for Otarski on a dark background"
---

Otarski ships configured with sensible defaults. This post documents every meaningful option you can change — what it does, where to find it, and what value to set.
...
Otarski ships with **12 colour themes**. All 12 are shown as coloured swatches in the header via the `ThemeSelector` component. Clicking a swatch switches the active theme instantly — no file edits, no rebuild. The logo badge, blog image gradients, and every brand colour on the page update live together.
...
All colour values in Otarski use the OKLCH colour space: `oklch(lightness% chroma hue)`.
...
Otarski has two header shapes. The landing and marketing layouts use a floating capsule:
...
For questions about how Otarski can support your roadmap, reach us via the [contact page](/contact).

---
title: "Getting Started with Otarski — From Install to Live in Minutes"
description: "How to install, configure, and deploy Otarski — covering site.config.ts, brand colours, navigation, writing posts, and deploying to Vercel."
publishedAt: 2026-03-27
author: "Team"
tags: ["otarski", "getting-started", "configuration", "vercel"]
featured: true
locale: en
image: "../../../assets/blog/otarski-getting-started.svg"
svgSlug: "otarski-getting-started"
imageAlt: "Accent icon above the words 'get started' on a dark background"
---

This guide walks you through everything needed to get Otarski running locally, configured to your brand, and deployed to the web. No previous Astro experience required.
...
From your checkout of this site repository, install dependencies and start the dev server:
...
Otarski ships with 12 ready-to-use colour themes. Pick your preferred theme by setting the `data-theme` attribute in `src/layouts/BaseLayout.astro`:
...
Otarski also supports [Netlify](https://netlify.com) out of the box. A `netlify.toml` is included with the correct build settings and security headers pre-configured.
...
To discuss an engineering engagement with Otarski, use the [contact page](/contact).
